...
const dataKombo=[
    {
        ...
        name: 'Kombo',
        price: 250,
        image: 'https://i.pinimg.com/736x/19/6e/86/196e86843d9e8caaafc92b08af1ea7b9.jpg',
...
function addLike(id) {
    const item = dataKombo.find(obj => obj.id === id);
    console.log(item);
    if (item) {
        item.like = !item.like;
    }
    ...
    <section class="w-full">
        <div class="container flex flex-col justify-center gap-2 mx-auto my-0 py-5 xs:px-10  px-8">
            ...
            <div class="grid md:grid-cols-3 lg:grid-cols-5 xs:grid-cols-2 grid-cols-1 gap-4">
               <div v-motion-pop-visible v-for="item in dataKombo" to="/" class="bg-white shadow rounded px-2 py-4">
